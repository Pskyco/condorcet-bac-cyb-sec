...
using SkorubaIS4.STS.Identity.Configuration;
using SkorubaIS4.STS.Identity.Configuration.ApplicationParts;
using SkorubaIS4.STS.Identity.Configuration.Constants;
using SkorubaIS4.STS.Identity.Configuration.Interfaces;
using SkorubaIS4.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace SkorubaIS4.STS.Identity.Helpers
{
